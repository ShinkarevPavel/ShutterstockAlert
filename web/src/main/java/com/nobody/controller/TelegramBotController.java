...
public class TelegramBotController {
  ...
  public TelegramBotController(
      TelegramServiceImpl telegramService, MessageToTelegramSender toTelegramSender) {
  ...
  public void create(
      @Validated(TelegramBotCredentialsDto.Create.class) @RequestBody
          TelegramBotCredentialsDto botCredentials) {
  ...
  @PatchMapping
  @ResponseStatus(HttpStatus.OK)
  public TelegramBotCredentialsDto update(
      @Validated(TelegramBotCredentialsDto.Update.class) @RequestBody
          TelegramBotCredentialsDto telegramBotCredentialsDto) {
    return telegramService.updateEntity(telegramBotCredentialsDto);
  }

  @PostMapping("/entity")
  public TelegramBotCredentialsDto getCredentials(
      @RequestBody TelegramBotCredentialsDto telegramBotCredentialsDto) {
