...
public class ScheduleController {
  ...
  public ScheduleController(
      ScheduleSettingsServiceImpl scheduleSettingsService,
  ...
  public void changeSchedule(
      @Validated(ScheduleSettingsDto.Change.class) @RequestBody
          ScheduleSettingsDto scheduleSettingsDto) {
  ...
  public void createSchedule(
      @Validated(ScheduleSettingsDto.Create.class) @RequestBody
          ScheduleSettingsDto scheduleSettingsDto) {
  ...
  public void updateSchedule(
      @Validated(ScheduleSettingsDto.Update.class) @RequestBody
          ScheduleSettingsDto scheduleSettingsDto) {
  ...
  @DeleteMapping
  @ResponseStatus(HttpStatus.OK)
  public void deleteSchedule(@RequestBody ScheduleSettingsDto scheduleSettingsDto) {
    scheduleSettingsService.removeEntity(scheduleSettingsDto);
  }
}
